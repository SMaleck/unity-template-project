...
namespace ExcelImporter.Editor.Templates.CompilingTemplates
{
    public class SheetImporter
    {
        ...
        public static void ImportData(ExcelWorkbook workbook, string sheetName, string importFilePath)
        {
            var excelSheet = workbook.Sheets[sheetName];
            var asset = CreateAsset<SheetImport>(importFilePath);

            var importedRows = new List<SheetImport.Row>();
            ...
            try
            {
                ...
                {
                    var importRow = new SheetImport.Row();
